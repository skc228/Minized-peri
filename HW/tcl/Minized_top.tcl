...
################################################################
# This is a generated script based on design: Minized_top
#
...
proc create_root_design { parentCell } {
  ...
  set USER_M_AXI_LITE [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 USER_M_AXI_LITE ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {USER_M_AXI_LITE} \
 ] $FCLK_CLK0
  set FCLK_CLK0_RSTN [ create_bd_port -dir O -from 0 -to 0 -type rst FCLK_CLK0_RSTN ]
...
\
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_ports USER_M_AXI_LITE] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_ports FCLK_CLK0_RSTN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_ports FCLK_CLK0]
  ...
  assign_bd_address -offset 0x40000000 -range 0x20000000 -with_name SEG_M01_AXI_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs USER_M_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x60010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
